...
% C++ Signature: int BinaryRenderer(float [] vertecies,size_t lenVertices,unsigned int [] triangleIDs,size_t lenTriangleIDs,bool [] shaded,size_t lenShaded,float windX,float windY,float windZ)

BinaryRendererDefinition = addFunction(libDef, ...
   "int BinaryRenderer(float [] vertecies,size_t lenVertices,unsigned int [] triangleIDs,size_t lenTriangleIDs,bool [] shaded,size_t lenShaded,float windX,float windY,float windZ)", ...
...
defineArgument(BinaryRendererDefinition, "shaded", "clib.array.BinaryShader.Bool", "input", "lenShaded"); % <MLTYPE> can be "clib.array.BinaryShader.Bool", or "logical"
defineArgument(BinaryRendererDefinition, "lenShaded", "uint64");
